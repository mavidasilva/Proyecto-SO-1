...
public class ControladorSimulacion {
    ...
    public VistaSimulacion getVista() { return vista; }
    public void setVista(VistaSimulacion vista) { this.vista = vista; }

    public void setRelojGlobal(int i) {
        SwingUtilities.invokeLater(() -> vista.setReloj(Integer.toString(i)));
    }

    public int getPolitica() { return vista.getPolitica(); }
    public int getTiempo() { return vista.getTiempoInstrucion(); }
